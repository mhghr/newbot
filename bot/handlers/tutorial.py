...
DEFAULT_APP_TUTORIALS = {
    "android": {
        "happ": {
            "name": "Happ",
            "text": (
                "۱. نرم‌افزار Happ را از گوگل‌پلی نصب کنید.\n"
                "۲. لینک اشتراک خود را از بخش «کانفیگ‌های من» کپی کنید.\n"
                "۳. برنامه را باز کنید و روی علامت + بزنید.\n"
                "۴. گزینه Add Subscription را انتخاب و لینک اشتراک را وارد (Import) کنید.\n"
                "۵. پس از به‌روزرسانی، کانفیگ‌ها اضافه می‌شوند؛ یکی را انتخاب و روی دکمه اتصال بزنید."
            ),
        },
        "v2box": {
            "name": "v2box",
    ...
    "ios": {
        "happ": {
            "name": "Happ",
            "text": (
                "۱. نرم‌افزار Happ را از App Store نصب کنید.\n"
                "۲. لینک اشتراک خود را از بخش «کانفیگ‌های من» کپی کنید.\n"
                "۳. برنامه را باز کنید و روی علامت + بزنید.\n"
                "۴. گزینه Add Subscription را انتخاب و لینک اشتراک را وارد کنید.\n"
                "۵. پس از به‌روزرسانی، کانفیگ‌ها اضافه می‌شوند؛ یکی را انتخاب و روی دکمه اتصال بزنید."
            ),
        },
        "v2raytun": {
